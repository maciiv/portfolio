...
exports.default = (function () { return (React.createElement(Layout_1.default, null,
    ...
    React.createElement(react_router_1.Route, { path: '/webapps/trivia', component: TriviaHome_1.default }),
    React.createElement(react_router_1.Route, { path: '/webapps/trivia-questions/:category?', component: TriviaQuestions_1.default }))); });
